...
https://github.com/madhu-111/How-to-install-Hadoop-on-Windows/tree/master/winutils/hadoop-3.3.0-YARN-8246/bin
...
```
git clone https://github.com/madhu-111/How-to-install-Hadoop-on-Windows.git
```
